...
/**
 * Provides the local service interface for YService. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author USER
 * @see YServiceLocalServiceUtil
...
public interface YServiceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link YServiceLocalServiceUtil} to access the y service local service. Add custom service methods to {@link com.yyms.adp.aaa.service.impl.YServiceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
